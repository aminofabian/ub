...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                // Unauthenticated /api/** calls must answer 401, not the default
                // bare 403: the web client's silent token-refresh recovery only
                // triggers on 401, so a 403 leaves the user stuck on a generic
                // "Something went wrong" error (e.g. dashboard pages after the
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // WebSocket upgrade and ops probes: auth is via single-use ticket query param, not JWT.
