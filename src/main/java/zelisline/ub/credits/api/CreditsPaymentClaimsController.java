...
public class CreditsPaymentClaimsController {
    ...
    public void approve(@PathVariable String claimId, HttpServletRequest request) {
        CurrentTenantUser.require(request);
        publicPaymentClaimService.approve(TenantRequestIds.resolveBusinessId(request), claimId);
    }
}
