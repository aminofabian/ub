...
@Entity
@Table(
        name = "wallet_credit_notification_dispatches",
        uniqueConstraints = @UniqueConstraint(name = "uq_wallet_credit_notif_sale", columnNames = "sale_id"))
public class WalletCreditNotificationDispatch {
