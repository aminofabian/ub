...
/**
 * Rate limits public guest-chat POSTs ({@code /api/v1/public/support/**}) by IP.
 */
@RequiredArgsConstructor
public class PublicSupportRateLimitFilter extends OncePerRequestFilter {

    private static final String PATH_PREFIX = "/api/v1/public/support/";
    ...
    protected void doFilterInternal(
        ...
        if (!rateLimiter.tryConsume(key)) {
            ...
            body.setDetail("Guest chat rate limit exceeded. Try again shortly.");
