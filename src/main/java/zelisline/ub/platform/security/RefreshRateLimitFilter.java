...
public class RefreshRateLimitFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (!rateLimiter.tryConsume(ip)) {
            ...
            body.setTitle("Too many refresh attempts");
